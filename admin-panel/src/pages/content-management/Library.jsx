...
export default function Library() {
  ...
  const renderModeButtons = () => (
    <div className="input-group">
      <button
        type="button"
        className={`btn btn-secondary btn-sm ${mode === 'list' ? 'current' : ''}`}
      ...
      <button
        type="button"
        className={`btn btn-secondary btn-sm ${mode === 'grid' ? 'current' : ''}`}
      ...
      {mode === 'list' && (
        <>
          ...
          <button type="button" className="btn btn-secondary btn-sm" onClick={() => modalAction.current.show()}>
            Apply
          </button>
        </>
      )}
    ...
    <>
      <div className="card mb-2">
        <div className="card-header d-flex justify-content-between align-items-center">
          ...
          <Link to="/content-management/media-library/upload" className="btn btn-secondary btn-sm" type="button">
