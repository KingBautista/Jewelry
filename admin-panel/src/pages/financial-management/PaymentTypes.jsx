...
export default function PaymentTypes() {
  ...
  const [options, setOptions] = useState({
    dataSource: '/financial-management/payment-types',
    dataFields: {
  ...
  const handleTabChange = (ev, type) => {
    ...
    setOptions(prevOptions => ({
      ...prevOptions,
      dataSource: isTrash ? '/financial-management/archived/payment-types' : '/financial-management/payment-types',
    }));
  };
  ...
  const getBulkActionUrl = (action, isTrash) => {
    switch (action) {
      case 'restore':
        return '/financial-management/payment-types/bulk/restore';
      case 'delete':
        return isTrash ? '/financial-management/payment-types/bulk/force-delete' : '/financial-management/payment-types/bulk/delete';
      default:
        return '';
    }
  };
        ...
        <div className="px-4" style={{ paddingTop: '0.50rem' }}>
          <div className="row g-2"> 
            ...
            <div className="col-lg-4 col-md-6 col-12 d-flex justify-content-end align-items-center">
              {access?.can_create && 
                <Link to="/financial-management/payment-types/create" className="btn btn-secondary w-100" type="button">
