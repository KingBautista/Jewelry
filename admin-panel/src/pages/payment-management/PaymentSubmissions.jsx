...
export default function PaymentSubmissions() {
  ...
  const [options, setOptions] = useState({
    dataSource: '/payment-management/submissions',
    dataFields: {
      ...
      submitted_at: { name: "Submitted At", withSort: true },
      reviewed_at: { name: "Reviewed At", withSort: true },
      reviewed_by_name: { name: "Reviewed By", withSort: true },
  ...
  const handleTabChange = (ev, type) => {
    ...
    setOptions(prevOptions => ({
      ...prevOptions,
      dataSource: isTrash ? '/payment-management/archived/submissions' : '/payment-management/submissions',
    }));
  };
          ...
          <div className="row"> 
            <div className="col-md-7 col-12">
             ...
             <div className="col-md-5 col-12 d-flex justify-content-end align-items-center">
              {access?.can_create && 
                <Link to="/payment-management/submissions/create" className="btn btn-secondary" type="button">
                ...
                <div className="modal-body p-4">
                  ...
                  <div className="mb-4">
                    <div 
                      ...
                      <h6 className="fw-bold mb-0" style={{ color: '#3b82f6' }}>Submission Status</h6>
