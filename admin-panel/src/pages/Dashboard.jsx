		...
		<div className="dashboard-metrics container-fluid">
			...
			<div className="row mb-4">
				<div className="col-12">
					<div className="card">
						<div className="card-body text-center">
									<FontAwesomeIcon icon={solidIconMap.calendar} className="mb-3" size="3x" />
							<h3 className="card-title">Financial Dashboard</h3>
									<p className="card-text">Quick view of financial health and customer activity</p>
					...
					<div className="card text-center border-warning">
						<div className="card-body">
							...
							<p className="card-text fs-3 fw-bold" style={{ color: '#f59e0b' }}>{formatCurrency(dashboardData.outstandingBalances)}</p>
									<small>Total unpaid amounts across all customers</small>
						</div>
					</div>
				</div>
				<div className="col-md-6">
									...
									<div className="p-2">
										<div className="d-flex align-items-center justify-content-center mb-1">
											...
											<h6 className="mb-0" style={{ color: '#10b981' }}>{formatCurrency(dashboardData.paymentBreakdown.paid)}</h6>
												...
												<small>Paid ({calculatePercentage(dashboardData.paymentBreakdown.paid, dashboardData.paymentBreakdown.paid + dashboardData.paymentBreakdown.pending)}%)</small>
									</div>
								</div>
								<div className="col-6">
									<div className="p-2">
										<div className="d-flex align-items-center justify-content-center mb-1">
											...
											<h6 className="mb-0" style={{ color: '#f59e0b' }}>{formatCurrency(dashboardData.paymentBreakdown.pending)}</h6>
												...
												<small>Pending ({calculatePercentage(dashboardData.paymentBreakdown.pending, dashboardData.paymentBreakdown.paid + dashboardData.paymentBreakdown.pending)}%)</small>
									</div>
								</div>
							</div>
						...
						<div className="card-body" style={{ padding: '0.25rem' }}>
							<div className="dashboard-table-responsive">
								<table className="table table-sm table-modern mb-0" style={{ marginBottom: '0', marginTop: '0' }}>
									<thead>
										<tr style={{ margin: '0' }}>
											<th style={{ fontSize: '0.8rem', padding: '0.25rem', margin: '0',  }}>Customer</th>
									...
									<tbody style={{ margin: '0' }}>
										{dashboardData.topCustomers.length > 0 ? (
											...
											<tr>
												<td colSpan="3" className="text-center py-3">No customer data available</td>
											</tr>
										)}
									</tbody>
								</table>
								...
								<table className="table table-sm table-modern table-striped table-hover mb-0" style={{ marginBottom: '0', marginTop: '0' }}>
									...
									<tbody style={{ margin: '0' }}>
										{Object.keys(dashboardData.paymentBreakdown.details || {}).length > 0 ? (
											...
											<tr>
												<td colSpan="5" className="text-center py-3">No payment data available</td>
											</tr>
										)}
									</tbody>
								</table>
