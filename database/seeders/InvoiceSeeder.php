    ...
    public function run(): void
    {
        ...
        $invoices = [
            [
                ...
                'price' => 150000.00,
                'product_image' => 'diamond-ring-1.jpg',
            ...
            [
                ...
                'price' => 75000.00,
                'product_image' => 'gold-necklace-set.jpg',
            ...
            [
                ...
                'price' => 25000.00,
                'product_image' => 'pearl-earrings.jpg',
        ...
        for ($i = 0; $i < $additionalCount; $i++) {
            ...
            $invoiceData = [
                ...
                'product_image' => $faker->optional(0.7)->imageUrl(400, 400, 'jewelry'),
